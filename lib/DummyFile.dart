...
class _NewHomeState extends State<NewHome> {
  ...
  void getarrayLength()async{
    await _firebase.collection("InvoiceID").doc("2dtDd787PkHNjpFag0H5").get().then((value){
      setState(() {
  ...
  //  print("pad value is : "+val);
   ...
   // print("Added value is : " + addval.toString());
    ...
    String storeval = show().toString()+mymonth.toString()+acyear.toString()+acyear1.toString()+addval.toString();
   // print(storeval);
