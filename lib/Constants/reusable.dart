...
class TxtStls {
  ...
  static TextStyle fieldtitlestyle = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 13, color: txtColor, fontWeight: FontWeight.bold),
      fontSize: 13,
      color: txtColor,
      fontWeight: FontWeight.bold);
  static TextStyle fieldtitlestyle3 = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 13, color: AbgColor, fontWeight: FontWeight.bold),
      fontSize: 13,
      color: AbgColor,
      fontWeight: FontWeight.bold);
  ...
  static TextStyle titlesstyle = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 13, color: bgColor, fontWeight: FontWeight.bold),
      fontSize: 13,
      color: bgColor,
      fontWeight: FontWeight.bold);
  static TextStyle titlesstyle10 = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 8, color: bgColor, fontWeight: FontWeight.bold),
      fontSize: 8,
      color: bgColor,
      fontWeight: FontWeight.bold);
  static TextStyle titlestyle14 = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 13, color: btnColor, fontWeight: FontWeight.bold),
      fontSize: 13,
      color: btnColor,
      fontWeight: FontWeight.bold);
  static TextStyle titlestyle15 = GoogleFonts.nunito(
      textStyle: const TextStyle(
          fontSize: 13, color: bluColor, fontWeight: FontWeight.bold),
      fontSize: 13,
      color: bluColor,
      fontWeight: FontWeight.bold);
  static TextStyle fieldtitlestylelarge = GoogleFonts.alata(
      ...
      color: txtColor,
      fontWeight: FontWeight.bold);
  static TextStyle tapstylebold = GoogleFonts.alata(
      textStyle: const TextStyle(
          fontSize: 15, color: txtColor, fontWeight: FontWeight.bold),
      fontSize: 15,
      color: txtColor,
      fontWeight: FontWeight.bold);
  static TextStyle tapstyleunderline = GoogleFonts.alata(
      textStyle: const TextStyle(
          fontSize: 15, color: txtColor, fontWeight: FontWeight.bold),
      fontSize: 15,
      color: txtColor,
  ...
  static TextStyle tapstyleitalic = GoogleFonts.alata(
      textStyle: const TextStyle(
          fontSize: 15, color: txtColor, fontWeight: FontWeight.bold),
      fontSize: 15,
      color: txtColor,
  ...
  static TextStyle notestyle = GoogleFonts.nunito(
      textStyle: const TextStyle(fontSize: 13, color: txtColor),
      fontSize: 13,
      color: txtColor);
  ...
  static TextStyle fieldstyle = GoogleFonts.nunito(
      ...
      letterSpacing: 0.2,
      fontSize: 12.5);
  static TextStyle smallfieldstyle = GoogleFonts.nunito(
      textStyle:
          const TextStyle(color: txtColor, fontSize: 10, letterSpacing: 0.2),
      color: txtColor,
      letterSpacing: 0.2,
      fontSize: 10);
  static TextStyle fieldstylelink = GoogleFonts.nunito(
      textStyle:
          const TextStyle(color: txtColor, fontSize: 12.5, letterSpacing: 0.2),
      color: txtColor,
      decoration: TextDecoration.underline,
  ...
  static TextStyle fieldstyle22 = GoogleFonts.nunito(
    textStyle:
        const TextStyle(color: txtColor, fontSize: 15, letterSpacing: 0.2),
    color: txtColor,
    letterSpacing: 0.2,
    fontSize: 15,
  );
  ...
  static TextStyle fieldstatusstyle = GoogleFonts.nunito(
      textStyle:
          const TextStyle(color: wonClr, fontSize: 12.5, letterSpacing: 0.2),
      color: wonClr,
      letterSpacing: 0.2,
      fontSize: 12.5);
  static TextStyle messagestyle = GoogleFonts.nunito(
      textStyle:
          const TextStyle(color: bgColor, fontSize: 12.5, letterSpacing: 0.2),
      color: bgColor,
      letterSpacing: 0.2,
      fontSize: 12.5);
  static TextStyle fieldstyle111 = GoogleFonts.nunito(
      textStyle: const TextStyle(color: bt, fontSize: 12.5, letterSpacing: 0.2),
      color: bt,
      letterSpacing: 0.2,
      fontSize: 12.5);
