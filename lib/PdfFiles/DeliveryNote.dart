...
class DeliveryNote {
  ...
  static generatepdf(BuildContext context, deliveryid) async {
    ...
    final bgImage = (await rootBundle.load("assets/Images/invoicebg.png"))
        .buffer
        .asUint8List();
    // pw.Container buildTable(hight1, hight2, align, text, text2, text3, text4,
    //     text5, text6, text7, style,
    //     [border]) {
    //   return pw.Container(
    //       height: hight1,
    //       child: pw.Table(
    ...
    final pageTheme = pw.PageTheme(
        ...
        margin: pw.EdgeInsets.only(left: 30, right: 30, top: 10, bottom: 20),
              ...
              children: [
                pw.Flexible(
                    ...
                    child: pw.Align(
                        ...
                        child: pw.Text("Original for Consignee".toUpperCase(),
                            textAlign: pw.TextAlign.right, style: textStl10))),
                    ...
                    children: [
                      pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text("XYZ Pvt Ltd", style: textStl10),
                      ...
                      pw.Column(
                        ...
                        mainAxisAlignment: pw.MainAxisAlignment.start,
                        children: [
                          pw.Text("Delivery Note No", style: textStl12),
                          pw.Text("Date :-  ${DateTime.now()}",
                              style: textStl10),
                          pw.Text("e-Way Bill No", style: textStl10),
                          pw.Text(r"Supplier's Reference", style: textStl10),
                          pw.Text(r"Buyer's Order No", style: textStl10),
                          pw.Text("Date :-  ${DateTime.now()}",
                              style: textStl10),
                          pw.Text("Dispatch Through", style: textStl10),
                          pw.Text("Destination", style: textStl10),
                          pw.Text("Terms of Delivery", style: textStl10),
                        ],
                      ),
                    ]),
                pw.SizedBox(height: 10),
                    ...
                    itemBuilder: (_, i) {
                      return pw.Row(children: [
                        ...
                        pw.Expanded(
                            flex: 2,
                            child: pw.Container(
                              child: pw.Text("76071190", style: textStl10),
                              alignment: pw.Alignment.center,
                            )),
                        pw.Expanded(
                            flex: 1,
                ...
                pw.Flexible(
                    flex: 1, child: pw.Text("Tax Amount(in words): Nil")),
                pw.SizedBox(height: 5),
                pw.Expanded(child: pw.SizedBox()),
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text("Received in Good Condition", style: textStl10),
                    pw.Text("XYZ PVT LTD", style: textStl10)
                  ],
                ),
                pw.Expanded(child: pw.SizedBox()),
                pw.Row(
                  mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                  children: [
                    pw.Text("", style: textStl10),
                    pw.Text("Authorized Signatory", style: textStl10)
                  ],
                )
              ]);
        }));
    ...
    try {
      ...
      print(2);
      TaskSnapshot upload =
          await storage.ref("DeliveryNote/${deliveryid}").putData(bytes);
      print(3);
