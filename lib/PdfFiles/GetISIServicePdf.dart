    ...
    pw.Flexible steps(step, text) {
      return pw.Flexible(
          ...
          child: pw.RichText(
            text: pw.TextSpan(
              children: [
                pw.TextSpan(text: step, style: textStl12Italic),
                pw.TextSpan(text: " - ", style: textStl12bold),
                pw.TextSpan(text: text, style: textStl12bold),
              ],
            ),
          ));
    }
                    ...
                    child: pw.Column(
                        ...
                        children: [
                          ...
                          servicerow(
                              ...
                              "it comes under ",
                              "Scheme - I of Schedule - II of BIS (Conformity Assessment) Regulations, 2016. ",
                              "ISI mark is granted to Indian manufacturers on the successful assessment of manufacturing infrastructure, production process, quality control, and testing capabilities through conducting a factory inspection and product testing."),
                          space2(),
                          pw.Align(
