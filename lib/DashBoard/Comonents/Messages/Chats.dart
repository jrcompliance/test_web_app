...
Map<String, UserInfo> chats = {
  ...
  'Yalagala Srinivas': UserInfo(messages: [
    {'sentByMe': 'true', 'text': 'yo!'},
    {'sentByMe': 'true', 'text': 'wassup?'},
    {'sentByMe': 'false', 'text': 'hi'},
    {'sentByMe': 'false', 'text': 'The work is done '}
  ], dp: 'https://post.medicalnewstoday.com/wp-content/uploads/sites/3/2020/01/326507_2200-732x549.jpg'),
  'Suresh Babu': UserInfo(messages: [
    {'sentByMe': 'true', 'text': 'yo!'},
    {'sentByMe': 'true', 'text': 'wassup?'},
    {'sentByMe': 'false', 'text': 'hi'},
...
class UserInfo {
  ...
  UserInfo({required this.messages, this.dp});
    ...
    return Container(
      ...
      child: ListView.builder(
          ...
          itemBuilder: (context, index) {
            Map<String, UserInfo> chats1 = {
              widget.chatUsername.toString(): UserInfo(messages: [{}])
            };
            return MessageTile(
...
class MessageTile extends StatelessWidget {
  ...
  MessageTile(
      {required this.message, required this.sendByMe, required this.name});
