...
import 'package:test_web_app/Widgets/ChatWidget.dart';
...
class _NotificationsState extends State<Notifications> {
  ...
  //             return Text(messages[i].message.toString());
  //           },
  //         );
  //       },
  //     ),
  ...
  // void send() {
  //   String receiverID = "agam";
  //   String messageText = _chatController.text;
